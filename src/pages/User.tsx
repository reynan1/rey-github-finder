...
function User() {
  const { userProfile, user, isLoading, getUserRepos, repos} = useContext(GithubContext)
      ...
      <div className="w-full mx-auto lg:w-10/12">
          ...
          <div className="custom-card-image mb-6 md:mb-0">
           ...
           <div className="col-span-2">
             ...
             <div className="w-full rounded-lg shadow-md bg-base-100 stats">
               { location &&  (
                <div className="stat">
                  <div className="stat-tittle text-md">
                    Location
                  </div>
        ...
        <div className="w-full py-5 mb-6 rounded-lg shadow-md bg-base-100 stats">
          <div className="stat">
            ...
            <div className="stat-value pr-5 text text-3xl md:text-4xl">
              {followers}
            </div>
          </div>
          <div className="stat">
          ...
          <div className="stat">
            <div className="stat-figure text-secondary">
               <FaCodepen className="text-3xl md:text-xl" />
            </div>
            <div className="stat-title pr-5 ">
              Public
            </div>
